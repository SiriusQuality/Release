...
namespace SiriusQualityEnergyBalance
{
	...
	/// <summary>
	///Class CalculateCropHeatFlux
    /// 
    /// </summary>
	public class CalculateCropHeatFlux : IStrategySiriusQualityEnergyBalance
	{

	#region Constructor

			public CalculateCropHeatFlux()
			{
				...
				pd2.PropertyType = (( SiriusQualityEnergyBalance.EnergyBalanceStateVarInfo.soilHeatFlux)).ValueType.TypeForCurrentValue;
				pd2.PropertyVarInfo =( SiriusQualityEnergyBalance.EnergyBalanceStateVarInfo.soilHeatFlux);
				_inputs0_0.Add(pd2);
				...
				pd4.PropertyType =  (( SiriusQualityEnergyBalance.EnergyBalanceStateVarInfo.cropHeatFlux)).ValueType.TypeForCurrentValue;
				pd4.PropertyVarInfo =(  SiriusQualityEnergyBalance.EnergyBalanceStateVarInfo.cropHeatFlux);
				_outputs0_0.Add(pd4);
	...
	#region pre/post conditions management		
			...
			public string TestPostConditions(SiriusQualityEnergyBalance.EnergyBalanceState energybalancestate, string callID)
			{
				try
				{
					...
					RangeBasedCondition r4 = new RangeBasedCondition(SiriusQualityEnergyBalance.EnergyBalanceStateVarInfo.cropHeatFlux);
					if(r4.ApplicableVarInfoValueTypes.Contains( SiriusQualityEnergyBalance.EnergyBalanceStateVarInfo.cropHeatFlux.ValueType)){prc.AddCondition(r4);}
			...
			public string TestPreConditions(SiriusQualityEnergyBalance.EnergyBalanceState energybalancestate, string callID)
			{
				try
				{
					...
					if(r2.ApplicableVarInfoValueTypes.Contains( SiriusQualityEnergyBalance.EnergyBalanceStateVarInfo.soilHeatFlux.ValueType)){prc.AddCondition(r2);}
	...
	#region Model
			...
			{				
				...
				//Code written below will not be overwritten by a future code generation
                energybalancestate.cropHeatFlux = energybalancestate.netRadiationEquivalentEvaporation - energybalancestate.soilHeatFlux - energybalancestate.potentialTranspiration;
