...
{
    class SQOCAN : Observation
    {
        protected override List<String> listParam()
        {
            List<String> sqocan = new List<String>();
            sqocan.Add("daily");
            return sqocan;
        }
        ...
        public override void run(bool isQuiet)
        {
            ...
            File.WriteAllText(dbm.ObservationsDIR + "\\" + "ObsSQCOAN.sqocan", buildAll(isQuiet));
        }
    }
}
