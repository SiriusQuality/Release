...
namespace SiriusQualityPhenology.Strategies
{
	...
	#region Constructor
			...
			public UpdatePhase()
			{
				...
				VarInfo v4 = new VarInfo();
				 v4.DefaultValue = 115;
				 v4.Description = "Base phyllochron";
				 v4.Id = 0;
				 v4.MaxValue = 1000;
				 v4.MinValue = 0;
				 v4.Name = "FixPhyll";
				...
				VarInfo v5 = new VarInfo();
				 v5.DefaultValue = 0;
				 v5.Description = "Duration of the endosperm cell division phase";
				 v5.Id = 0;
				 v5.MaxValue = 10000;
				 v5.MinValue = 0;
				 v5.Name = "Dcd";
				...
				VarInfo v6 = new VarInfo();
				 v6.DefaultValue = 0;
				 v6.Description = "Grain filling duration (from anthesis to physiological maturity)";
				 v6.Id = 0;
				 v6.MaxValue = 10000;
				 v6.MinValue = 0;
				 v6.Name = "Dgf";
				...
				VarInfo v7 = new VarInfo();
				 v7.DefaultValue = 0;
				 v7.Description = "Grain maturation duration (from physiological maturity to harvest ripeness)";
				 v7.Id = 0;
				 v7.MaxValue = 10000;
				 v7.MinValue = 0;
				 v7.Name = "Degfm";
				...
				VarInfo v9 = new VarInfo();
				 v9.DefaultValue = 0;
				 v9.Description = "Daylength response of leaf production";
				 v9.Id = 0;
				 v9.MaxValue = 1;
				 v9.MinValue = 0;
				 v9.Name = "SLDL";
				...
				VarInfo v10 = new VarInfo();
				 v10.DefaultValue = 0;
				 v10.Description = "true to ignore grain maturation";
				 v10.Id = 0;
				 v10.MaxValue = 1;
				 v10.MinValue = 0;
				 v10.Name = "IgnoreGrainMaturation";
				 v10.Size = 1;
				 v10.Units = "-";
				 v10.URL = "";
				...
				VarInfo v11 = new VarInfo();
				 v11.DefaultValue = 1;
				 v11.Description = "Number of phyllochron between heading and anthesis";
				 v11.Id = 0;
				 v11.MaxValue = 3;
				 v11.MinValue = 0;
				 v11.Name = "PHEADANTH";
				...
				VarInfo v12 = new VarInfo();
				 v12.DefaultValue = 0;
				 v12.Description = "true if maize";
				 v12.Id = 0;
				 v12.MaxValue = 1;
				 v12.MinValue = 0;
				 v12.Name = "SwitchMaize";
				 v12.Size = 1;
				 v12.Units = "-";
				 v12.URL = "";
				...
				pd12.PropertyName = "FinalLeafNumber";
				pd12.PropertyType =  (( SiriusQualityPhenology.PhenologyStateVarInfo.FinalLeafNumber)).ValueType.TypeForCurrentValue;
				pd12.PropertyVarInfo =(  SiriusQualityPhenology.PhenologyStateVarInfo.FinalLeafNumber);
				_outputs0_0.Add(pd12);
				PropertyDescription pd13 = new PropertyDescription();
				pd13.DomainClassType = typeof(SiriusQualityPhenology.PhenologyState);
				pd13.PropertyName = "phase_";
				pd13.PropertyType =  (( SiriusQualityPhenology.PhenologyStateVarInfo.phase_)).ValueType.TypeForCurrentValue;
				pd13.PropertyVarInfo =(  SiriusQualityPhenology.PhenologyStateVarInfo.phase_);
				...
				pd14.PropertyType =  (( SiriusQualityPhenology.PhenologyStateVarInfo.hasLastPrimordiumAppeared)).ValueType.TypeForCurrentValue;
				pd14.PropertyVarInfo =(  SiriusQualityPhenology.PhenologyStateVarInfo.hasLastPrimordiumAppeared);
    ...
    #region Instances of the parameters
			...
			{ 
				get {
						VarInfo vi= _modellingOptionsManager.GetParameterByName("FixPhyll");
						if (vi != null && vi.CurrentValue!=null) return (Double)vi.CurrentValue ;
						else throw new Exception("Parameter 'FixPhyll' not found (or found null) in strategy 'UpdatePhase'");
				 } set {
							VarInfo vi = _modellingOptionsManager.GetParameterByName("FixPhyll");
							if (vi != null)  vi.CurrentValue=value;
						else throw new Exception("Parameter 'FixPhyll' not found in strategy 'UpdatePhase'");
				}
			}
			public Double Dcd
			{ 
	...
	#region Static parameters VarInfo definition
			...
			{                                
				...
				FixPhyllVarInfo.Name = "FixPhyll";
				FixPhyllVarInfo.Description =" Base phyllochron";
				FixPhyllVarInfo.MaxValue = 1000;
				FixPhyllVarInfo.MinValue = 0;
				FixPhyllVarInfo.DefaultValue = 115;
				FixPhyllVarInfo.Units = "leaf/°Cd";
				FixPhyllVarInfo.ValueType = CRA.ModelLayer.Core.VarInfoValueTypes.GetInstanceForName("Double");
			...
			//Parameters static VarInfo list 
				...
				private static VarInfo _FixPhyllVarInfo= new VarInfo();
				/// <summary> 
				///FixPhyll VarInfo definition
				/// </summary>
				public static VarInfo FixPhyllVarInfo
				{
					get { return _FixPhyllVarInfo; }
				}
	...
	#region pre/post conditions management		
			...
			public string TestPostConditions(SiriusQualityPhenology.PhenologyState phenologystate,SiriusQualityPhenology.PhenologyState phenologystate1, string callID)
			{
				try
				{
					...
					RangeBasedCondition r12 = new RangeBasedCondition(SiriusQualityPhenology.PhenologyStateVarInfo.FinalLeafNumber);
					if(r12.ApplicableVarInfoValueTypes.Contains( SiriusQualityPhenology.PhenologyStateVarInfo.FinalLeafNumber.ValueType)){prc.AddCondition(r12);}
					RangeBasedCondition r13 = new RangeBasedCondition(SiriusQualityPhenology.PhenologyStateVarInfo.phase_);
					if(r13.ApplicableVarInfoValueTypes.Contains( SiriusQualityPhenology.PhenologyStateVarInfo.phase_.ValueType)){prc.AddCondition(r13);}
					RangeBasedCondition r14 = new RangeBasedCondition(SiriusQualityPhenology.PhenologyStateVarInfo.hasLastPrimordiumAppeared);
					if(r14.ApplicableVarInfoValueTypes.Contains( SiriusQualityPhenology.PhenologyStateVarInfo.hasLastPrimordiumAppeared.ValueType)){prc.AddCondition(r14);}
			...
			public string TestPreConditions(SiriusQualityPhenology.PhenologyState phenologystate,SiriusQualityPhenology.PhenologyState phenologystate1, string callID)
			{
				try
				{
					...
					prc.AddCondition(new RangeBasedCondition(_modellingOptionsManager.GetParameterByName("FixPhyll")));
