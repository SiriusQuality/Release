...
namespace SiriusQualityPhenology.Strategies
{
	...
	/// <summary>
	///Class CalculatePhyllochron
    /// Calculate the phyllochron 
    /// </summary>
	public class CalculatePhyllochron : IStrategySiriusQualityPhenology
	{
	...
	#region Implementation of IAnnotatable
			...
			{
				get { return "Calculate the phyllochron "; }
			}
    ...
    #region Instances of the parameters
			...
			{ 
				get {
						...
						else throw new Exception("Parameter 'Ldecr' not found (or found null) in strategy 'CalculatePhyllochron'");
				 } set {
							VarInfo vi = _modellingOptionsManager.GetParameterByName("Ldecr");
							if (vi != null)  vi.CurrentValue=value;
						else throw new Exception("Parameter 'Ldecr' not found in strategy 'CalculatePhyllochron'");
				}
			}
			public Double Lincr
			{ 
				get {
						...
						if (vi != null && vi.CurrentValue!=null) return (Double)vi.CurrentValue ;
						else throw new Exception("Parameter 'Lincr' not found (or found null) in strategy 'CalculatePhyllochron'");
				 } set {
							VarInfo vi = _modellingOptionsManager.GetParameterByName("Lincr");
							if (vi != null)  vi.CurrentValue=value;
						else throw new Exception("Parameter 'Lincr' not found in strategy 'CalculatePhyllochron'");
				}
			}
			public Double Pdecr
			{ 
				get {
						...
						if (vi != null && vi.CurrentValue!=null) return (Double)vi.CurrentValue ;
						else throw new Exception("Parameter 'Pdecr' not found (or found null) in strategy 'CalculatePhyllochron'");
				 } set {
							VarInfo vi = _modellingOptionsManager.GetParameterByName("Pdecr");
							if (vi != null)  vi.CurrentValue=value;
						else throw new Exception("Parameter 'Pdecr' not found in strategy 'CalculatePhyllochron'");
				}
			}
			public Double Pincr
			{ 
				get {
						...
						if (vi != null && vi.CurrentValue!=null) return (Double)vi.CurrentValue ;
						else throw new Exception("Parameter 'Pincr' not found (or found null) in strategy 'CalculatePhyllochron'");
				 } set {
							VarInfo vi = _modellingOptionsManager.GetParameterByName("Pincr");
							if (vi != null)  vi.CurrentValue=value;
						else throw new Exception("Parameter 'Pincr' not found in strategy 'CalculatePhyllochron'");
				}
			}
			...
			{ 
				get {
						...
						if (vi != null && vi.CurrentValue!=null) return (Double)vi.CurrentValue ;
						else throw new Exception("Parameter 'FixPhyll' not found (or found null) in strategy 'CalculatePhyllochron'");
				 } set {
							VarInfo vi = _modellingOptionsManager.GetParameterByName("FixPhyll");
							if (vi != null)  vi.CurrentValue=value;
						else throw new Exception("Parameter 'FixPhyll' not found in strategy 'CalculatePhyllochron'");
				}
			}
	...
	#region Model
			...
			{				
				...
				//Code written below will not be overwritten by a future code generation
                if (phenologystate.LeafNumber < Ldecr) phenologystate.Phyllochron = FixPhyll * Pdecr;
                else if (phenologystate.LeafNumber >= Ldecr && phenologystate.LeafNumber < Lincr) phenologystate.Phyllochron = FixPhyll;
                else phenologystate.Phyllochron = FixPhyll * Pincr;
