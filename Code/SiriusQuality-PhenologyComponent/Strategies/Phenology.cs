...
namespace SiriusQualityPhenology.Strategies
{
    ...
    #region Instances of the parameters
			...
			{ 
				get {
						return _calculatephyllochron.FixPhyll ;
				}
				set {
						_calculatephyllochron.FixPhyll=value;
						_updatephase.FixPhyll=value;
				}
			}
			public Double SowingDensity
			{ 
				get {
						return _calculateshootnumber.SowingDensity ;
				}
				set {
	...
	#region Static parameters VarInfo definition
			...
			//Parameters static VarInfo list of the composite class
				...
				{
					get { return SiriusQualityPhenology.Strategies.CalculatePhyllochron.FixPhyllVarInfo; }
				}
				/// <summary> 
				...
				{
					get { return SiriusQualityPhenology.Strategies.CalculateShootNumber.SowingDensityVarInfo; }
				}
				/// <summary> 
