...
{
    public class OutputFileExtractorV15 : OutputFileExtractor
    {
        #region normal
        ...
        internal override PageData NormalRun(Run runOld)
        {
            ...
            PrintDailyHourlyVPDair(page, runOld);
            page.SetHeight(NormalSize * 9 + headerHeight);

            PrintDailyHourlyCanopyTemp(page, runOld);
        ...
        public static void PrintDailyCrop(PageData page, Run runOld)
        {
            ...
            page.NewLine()
                .Add("Date")
                .Add("Thermal time (Developmental)")
                .Add("Mean air")
                .Add("Mean soil")
                .Add("Mean canopy")
                .Add("Rooting")
                ...
                .Add("Excess Nitrogen");
                //.Add("CN Grain Limitation")
                //.Add("Thermal time (grain)")
                //.Add("Delta Thermal time (shoot)")
                //.Add("Phase Number")
                //.Add("N Storage")
                //.Add("C Storage (Starch)")
                //.Add("dN/dt Storage")
                //.Add("dC/dt Storage (Starch)")
                //.Add("UptakeRatio/Remob N")
                //.Add("UptakeRatio/Remob DM")
                //.Add("Max T soil")
                //.Add("Min T soil");
                //.Add("Original N Suppply after Cell %")
                //.Add("C Supply with remob")
                //.Add("C Supply without remob")
                //.Add("NC Ratio With Remob")
                //.Add("NC Ratio Without Remob");
                //.Add("Suppply after Remob %")
                //.Add("Uptake Scenescence pool")
                //.Add("Uptake Stem")
                //.Add("Uptake Leaf Exposed Sheath");
            ...
            for (var i = 1; i < nbDay; ++i)
            {
                ...
                if (i >= sowDay)
                {
                    ...
                    page.NewLine()
                        ...
                        .Add((universe.Crop_.AccumPAR), 2)
                        .Add(universe.Soil_.CalculateZoneAvailableWaterTop90(), 2, Run.GwaterToMMwater)
                        .Add(universe.Soil_.CalculateZoneExcessWaterTop90(), 2, Run.GwaterToMMwater)
                        .Add(universe.Soil_.CalculateZoneAvailableNitrogenTop90(), 2, 10)
                        .Add(universe.Soil_.CalculateZoneExcessNitrogenTop90(), 2, 10);
                        //.Add(universe.Crop_.TagGrainCN)
                        //.Add(universe.Crop_.GrainCumulTT)
                        //.Add(universe.thermalTimeWrapper_.getDeltaTT(Delta.Shoot))
                        //.Add(universe.Crop_.getPhaseValue())
                        //.Add(universe.Crop_.NStorage)
                        //.Add(universe.Crop_.Starch)
                        //.Add(universe.Crop_.NSupplyperGrain)
                        //.Add(universe.Crop_.CSupplyperGrain)
                        //.Add(universe.Crop_.OutUptakeRatioN)
                        //.Add(universe.Crop_.OutUptakeRatioDM)
                        //.Add(universe.thermalTimeWrapper_.CumulTT[0])
                        //.Add(universe.meteorologyWrapper_.RadTopAtm)
                        //.Add(universe.Soil_.SoilMaxTemperature)
                        //.Add(universe.Soil_.SoilMinTemperature)
                        //.Add(universe.Soil_.SoilDeepLayer_.Temperature)
                        //.Add(universe.Crop_.Phyllochron);
                        //.Add(System.String.Format("NAdded[{0}]={1};", count, universe.NAdded));
                        //.Add(universe.Crop_.CSupplyWORemob)
                        //.Add(universe.Crop_.NCRatioWRemob)
                        //.Add(universe.Crop_.NCRatioWORemob);
                        //.Add(universe.Crop_.NSupplyAfterRemob)
                        //.Add(universe.Crop_.UEN1)
                        //.Add(universe.Crop_.UEN2)
                        //.Add(universe.Crop_.UEN3);
                    count++;
                }
            }
        }
        ...
        public static void PrintDailyWaterSoil(PageData page, Run runOld)
        {
            ...
            for (var i = 0; i < nbDay; ++i)
            {
                ...
                for (var j = 0; j < 23; ++j)
                {
                    valueLine.Add(universe.meteorologyWrapper_.HourlyRadiation[j]);
                }
                valueLine.SetWidth(204);
        ...
        {
            page.NewLine()
                .Add("Date").Add("hourlyVPDair (hPa)").SetWidth(21);
        ...
        {
            /*   page.NewLine()
                   .Add("Date").Add("HourlyCanopyTemp (°C)").SetWidth(21);
               ...
               */
            page.NewLine()
            .Add("Date").Add("HourlyAirTemp (°C)").SetWidth(21);
        ...
        public static void PrintMultiRunSummaryCrop(LineData line, Run runOld)
        {
            ...
            if (maturityUniverse != null) line.Add(maturityUniverse.Crop_.AccumPAR, 2);
            else line.Add("?");
        ...
        public static IEnumerable<string> SummaryHeaders1()
        {
            ...
            yield return "Water use efficiency";
            yield return "Water use efficiency";
            yield return "Cumulative Intercepted PAR";
        ...
        public static IEnumerable<string> SummaryValues(Run run)
        {
            ...
            if (maturityUniverse != null) yield return FormatNumber(maturityUniverse.Crop_.AccumPAR, 2);
            else yield return "?";
        }
