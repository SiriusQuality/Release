...
!> $URL: https://biot.eos.ubc.ca/svn/min3p_thcm/branches/fgerard_new/src/dgm/diffcoff_g.F90 $
!---------------------------------------------------------------------
!********************************************************************!
...
!c ----------------------------------------------------------------------
      ...
      real*8 function diffcoff_g(diff_p,sat_p,por,tortuosity_corr,     &
        ...
        real*8 :: diff_p,sat_p,por,tau, sat_oil, m_archie, diffcoff
	    ...
	    else if (gas_tortuosity.eq.'manual') then
