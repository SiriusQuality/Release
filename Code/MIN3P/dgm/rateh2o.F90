...
!> $URL: https://biot.eos.ubc.ca/svn/min3p_thcm/branches/fgerard_new/src/dgm/rateh2o.F90 $
!---------------------------------------------------------------------
!********************************************************************!
...
!c ----------------------------------------------------------------------
      ...
      external bulkconc, rateint, rateint_new, rateredx,               & 
     &         totmin_w, totredx_w, totint_w

      real*8, parameter :: r55 = 55.5d0
      
      real*8 :: totmdp_w, totor_w, totaq_w, bulkconc
...
!c loop over all control volumes
    ...
    !$omp default(shared)                                             &
    !$omp private (ivol, ir, iaq, totmdp_w, totor_w, totaq_w)                                              
