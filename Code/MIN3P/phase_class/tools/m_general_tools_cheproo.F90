...
!> $URL: https://biot.eos.ubc.ca/svn/min3p_thcm/branches/fgerard_new/src/phase_class/tools/m_general_tools_cheproo.F90 $
!---------------------------------------------------------------------
!********************************************************************!
...
!c-------------------------------------------------------------
    do ival=1,nval 
#ifdef STANDARD_FORTRAN
      write(ioutput,'(3e15.7,100e15.7)') x(ival),y(ival),z(ival),    &
