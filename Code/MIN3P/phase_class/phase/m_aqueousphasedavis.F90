...
!> $URL: https://biot.eos.ubc.ca/svn/min3p_thcm/branches/fgerard_new/src/phase_class/phase/m_aqueousphasedavis.F90 $
!---------------------------------------------------------------------
!********************************************************************!
...
! Compute activity coefficients according Debye-Hückel aproximation.
...
real*8                                 :: agamma     ! Debye-Hückel parameter

real*8                                 :: bgamma     ! Debye-Hückel parameter

real*8                                 :: bdot       ! Debye-Hückel parameter
...
type(t_aqueousphasedavis), intent(inout):: this  ! Type aqueous phase Debye-Hückel
...
type(t_aqueousphasedavis), intent(inout)            :: this  ! Type aqueous phase (Debye-Hückel model) variable
...
type (t_aqueousphasedavis), intent(in) :: this     ! Type aqueous phase (Debye-Hückel model) variable
...
write (ioutput,*) '-    Activity model: Debye-Hückel  -'
...
! of aqueous species according Extended Debye-Hückel model.
...
type(t_aqueousphasedavis), intent(out):: copied  ! Type aqueous phase (Debye-Hückel model) variable
