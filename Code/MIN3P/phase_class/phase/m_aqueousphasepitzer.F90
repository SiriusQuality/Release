...
!> $URL: https://biot.eos.ubc.ca/svn/min3p_thcm/branches/fgerard_new/src/phase_class/phase/m_aqueousphasepitzer.F90 $
!---------------------------------------------------------------------
!********************************************************************!
...
!%-------------------------------------------------------------
!% Constant Debye-Hückel parameter
!%-------------------------------------------------------------
bdh=1.2d0,                  & 
!%-------------------------------------------------------------
!% Limiting Debye-Hückel slope to 25?  0.39153  0.392
!%-------------------------------------------------------------
aphi25=0.392d0,             &  
!%-------------------------------------------------------------
!% Limiting Debye-Hückel slope to 25?for density calculations 
!% dAphi/dP??
!% cm3 kg1/2/mol3/2
...
aphi25vol=1.8743d0,         &                               
!%-------------------------------------------------------------
!cprovi aphi25=0.39153d0,   & ! Limiting Debye-Hückel slope to 25?  0.39153  0.392
!%-------------------------------------------------------------
...
real*8                                 :: aphi          ! Debye-Hückel limiting slope
...
if (iserror) goto 20 
!%-----------------------------------------------------------
!% Write parameters concerning to Debye-Hückel term 
!%-----------------------------------------------------------
write(ioutput,*)  '-------------------------------------------------------------------'
...
! the object. At the present version, Debye-Hückel limiting slope is updated 
...
!%----------------------------------------------------------
!%----------------------------------------------------------
!% Compute Debye-Hückel contribution to osmotic coefficient 
!% derivative
!%----------------------------------------------------------
dosco=0.0d0
sqri = sqrt(ionstr)
...
real*8, intent(in)                 :: dhterm  ! Derivative of the Debye-Hückel term with respect to ionic strength
...
real*8, intent(in)     :: ddh    ! Derivative of the modified Debye-Hückel 
