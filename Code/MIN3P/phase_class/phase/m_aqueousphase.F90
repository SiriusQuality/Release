...
!> $URL: https://biot.eos.ubc.ca/svn/min3p_thcm/branches/fgerard_new/src/phase_class/phase/m_aqueousphase.F90 $
!---------------------------------------------------------------------
!********************************************************************!
...
type(t_aqueousphasedavis), pointer   :: paqphdavis    ! Aqueous phase with Debye-Hückel (extended) model.
