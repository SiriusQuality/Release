...
!> $URL: https://biot.eos.ubc.ca/svn/min3p_thcm/branches/fgerard_new/src/min3p/chem.F90 $
!---------------------------------------------------------------------
!********************************************************************!
...
!c ----------------------------------------------------------------------
      ...
      character*12, allocatable :: ctype_bzrt_series(:,:,:)
...
!c           phguess_series(nbzrt,ntsrc+1)
!c                              = guess for pH of transient boundary condition series
...
!c           totco_series(n,nbzrt,ntsrc+1)  
!c                                = transient boundary condition series of total 
!c                                  aqueous component concentrations [moles/l water]
...
!c ----------------------------------------------------------------------
      ...
      real (type_r8), allocatable :: totco_series(:,:,:)
      ...
      real (type_r8), allocatable :: phguess_series(:,:)
...
!c                                conditions
!c           scalfac_aq_series(naq,nbzrt,ntsrc+1)
...
!c ----------------------------------------------------------------------
      ...
      real (type_r8), allocatable :: scalfac_aq_series(:,:,:)
