...
!> $URL: https://biot.eos.ubc.ca/svn/min3p_thcm/branches/fgerard_new/src/min3p/velocity.F90 $
!---------------------------------------------------------------------
!********************************************************************!
...
!c ----------------------------------------------------------------------
     ...
     &                    offset)
      ...
      use gen, only : rank, b_enable_output, node_idx_lg2l,            &
                      ...
                      mpiarray_starts_sub_ivel,lost_water !TR 03/21
#ifdef PETSC
...
!c  write average interfacial velocities to output file
            ...
            if (b_output_binary) then
              ...
              write(ivel,'(6e15.7)') xg_out,yg_out,zg_out,             &
                                     (vel(idim),idim=1,3)
