...
!> $URL: https://biot.eos.ubc.ca/svn/min3p_thcm/branches/fgerard_new/src/min3p/satfpres.F90 $
!---------------------------------------------------------------------
!********************************************************************!
...
!c ----------------------------------------------------------------------
     ...
     &                         spalpha,spbeta,spgamma)
      !DEC$ ATTRIBUTES STDCALL, ALIAS:"SATFPRES" , DLLEXPORT :: satfpres
      !DEC$ ATTRIBUTES REFERENCE :: swr
      !DEC$ ATTRIBUTES REFERENCE :: aentry
      !DEC$ ATTRIBUTES REFERENCE :: pressure
      !DEC$ ATTRIBUTES REFERENCE :: spalpha
      !DEC$ ATTRIBUTES REFERENCE :: spbeta
      !DEC$ ATTRIBUTES REFERENCE :: spgamma
