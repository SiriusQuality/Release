...
!> $URL: https://biot.eos.ubc.ca/svn/min3p_thcm/branches/fgerard_new/src/min3p/velocity_a.F90 $
!---------------------------------------------------------------------
!********************************************************************!
...
#include <finclude/petscsys.h>
    ...
    real*8 :: distance, fluxv_vl, fluxd, xg_out, yg_out, zg_out

    external cliqdisp
    external fluxd, fluxv, fluxv_vl,   &
     &         totconc, elecmigration
...
!c  local variables
    ...
    real*8, parameter :: r1 = 1.0d0, rverysmall = 1.d-30
        ...
        real*8 aread(3,12), vela(3), vela_adv(n,3), vela_dif(n,3),     &
...
!c  find the average interfacial velocity in the x,y,z directions
              ...
              vela(idim) = vela(idim)/(float( npair(idim) ) + eps)
...
!c           mass fluxes
            ...
            do ic=1,n
              ...
              if (b_output_binary) then
                ...
                write(igsa2,'(18e15.7)') xg_out,yg_out,zg_out,         &
                                     (vela_adv(ic,idim),idim=1,3),     &
                                     (vela_dif(ic,idim),idim=1,3),     &
                                     (vela_mig(ic,idim),idim=1,3),     &
                                     (vela_tot(ic,idim),idim=1,3)
