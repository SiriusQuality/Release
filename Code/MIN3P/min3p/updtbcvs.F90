...
!> $URL: https://biot.eos.ubc.ca/svn/min3p_thcm/branches/fgerard_new/src/min3p/updtbcvs.F90 $
!---------------------------------------------------------------------
!********************************************************************!
...
!c  read name of zone
        write(1000,*) 'precip : ', rwork(1,1), irrig_sirius 
        rwork(1,1) = rwork(1,1) + irrig_sirius !TR add irrig from sirius
        irrig_sirius = 0 !TR - put it at 0 after adding it
