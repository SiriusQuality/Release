...
!> $URL: https://biot.eos.ubc.ca/svn/min3p_thcm/branches/fgerard_new/src/min3p/icrtlczn.F90 $
!---------------------------------------------------------------------
!********************************************************************!
...
!c ----------------------------------------------------------------------
      ...
      external  findstrg, findzone, guess, initgeom, readzone
...
!c  distribute mineralogical parameters 
          ...
          call distmp(cmcnew(:,tid),phic(:,tid),areac)
