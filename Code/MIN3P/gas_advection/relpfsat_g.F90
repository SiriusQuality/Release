...
!> $URL: https://biot.eos.ubc.ca/svn/min3p_thcm/branches/fgerard_new/src/gas_advection/relpfsat_g.F90 $
!---------------------------------------------------------------------
!********************************************************************!
!c ----------------------------------------------------------------------
...
!         
!#ifdef DEBUG
!         write(*,'(3(a,1x,e16.8,1x))') "rkw_1",rkw_1,"dk_ds",dk_ds,"relpfsat_g",relpfsat_g
!#endif
