...
namespace NameSpace
{
    ...
    /// <summary>ClassNameVarInfoClasses contain the attributes for each variable in the domain class RainData. Attributes are valorized via the static constructor. The data-type VarInfo causes  a dependency to the assembly CRA.Core.Preconditions.dll</summary>
    public class ClassNameVarInfo : IVarInfoClass
    {
        ...
        static ClassNameVarInfo()
        {
            ClassNameVarInfo.DescribeVariables();
        }
        ...
        static void DescribeVariables()
        {
            ...
            _radTopAtm.Description = "Exrtraterestrial radiations";
